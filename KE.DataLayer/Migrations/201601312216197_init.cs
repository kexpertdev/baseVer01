namespace KE.DataLayer.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MotherLastName = c.String(maxLength: 100),
                        MotherFirstName = c.String(maxLength: 100),
                        MotherMiddleName = c.String(maxLength: 100),
                ...
                c => new
                    {
                        ...
                        Broker_ID = c.Int(nullable: false),
                        Product_ID = c.Int(nullable: false),
                        PolicyType_ID = c.Byte(nullable: false),
                        PolicyStartDate = c.DateTimeOffset(nullable: false, precision: 7),
                        ...
                        IsLegalPerson = c.Byte(nullable: false),
                        PostalCode = c.String(maxLength: 6),
                        InsuranceCompany = c.Int(nullable: false),
                        InsurancePolicyNumber = c.String(maxLength: 50),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.InsurancePolicy", "PolicyPeriod_ID", "dbo.PolicyPeriod");
            ...
            DropIndex("dbo.InsurancePolicy", new[] { "PolicyPeriod_ID" });
